...
<!-- 			<select id="id_type" class="easyui-combobox"  data-options="editable:false" style="width: 100px;">
				<option value="">-用品类别-</option>
				<option value="1">手消毒液</option>
				<option value="2">普通洗手液</option>
				<option value="3">抗菌洗手液</option>
				<option value="4">干手纸</option>
			</select> -->
			<nis:select name="id_type" id="id_type" exp="style='width: 100px;' data-options='editable:false'"  headerKey="" headerValue="-用品类别-" dictcode="swsType" cssCls="easyui-combobox"/>	
