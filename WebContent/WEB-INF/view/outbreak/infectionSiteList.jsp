...
<script type="text/javascript">
	...
	$(function(){
		$('#' + pathogenPatient.panel).datagrid({
		    ...
		    autoRowHeight: true,
		    striped: true,		    
		    url:'${webroot}/by007Show/f_json/findInfectionSiteList.shtml?dataType=${param.dataType}&id=${param.id}&deptId=${param.deptId}&moniDate=${param.moniDate}&queryStartDate=${param.queryStartDate}&queryEndDate=${param.queryEndDate}',   
		    remoteSort: false,
		    singleSelect: true,
		    fitColumns: true,
		    border:false,
		    columns:[ 
		     	[
				  ...
				  {field:'inHospAt',title:'入院日期',sortable:true,width:95,align:'center'},
		          {field:'inDeptName',title:'入院科室',sortable:true,width:130},
		          {field:'outAt',title:'出院日期',sortable:true,width:95,align:'center'},
		          {field:'outDeptName',title:'出院科室',sortable:true,width:130},
		          {field:'chargeDrName',title:'主管医生',sortable:true,width:70,align:'center'},
		          {field:'infection',title:'预警原因',sortable:true,width:140,
					styler: function(value,row,index) {
						return 'color:#FF6600;';
					}
		          },
		          {field:'moniDate',title:'感染日期',sortable:true,width:100}
		      ]
		    ],
	        rownumbers:true,
