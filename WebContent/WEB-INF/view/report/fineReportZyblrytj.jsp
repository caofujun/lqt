...
<body>
	...
	<div data-options="iframe:true,region:'center'" style="border-width: 0px;">
			 <div id="patient_frame_tabs" class="easyui-tabs" data-options="fit:true,plain:true">
			   <nis:auth menuNo="zybl0301">
			   <div title="职业暴露发生岗位/性别/工龄分布统计"  data-options="href:'${webroot}/report/f_view/fineReportZyblrytjFrame.shtml?reportFile=nis7/ZYBLDJ&__bypagesize__=false&id=zy2'"></div>
			   </nis:auth>
			   <nis:auth menuNo="zybl0302">
			   <div title="职业暴露发生科室分布统计"  data-options="href:'${webroot}/report/f_view/fineReportZyblrytjFrame.shtml?reportFile=nis7/ZYBLKSDJ&__bypagesize__=false&id=zy1'"></div>
		    	</nis:auth>
		    </div>    
	 </div>
    </div>
