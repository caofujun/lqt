...
<div class="easyui-layout" style="width: 100%;height: 100%;">
	...
	<table class="table_cx h_set" cellpadding="0" cellspacing="0">
		<tbody>
			...
			<tr>
				<td class="t_title">人员类型：</td>
				<td>
					<nis:select id="personnelType" name="personnelType" headerKey="" headerValue="不限" exp="style='width: 150px;'" dictcode="personnel_type"/>
				</td>
			</tr>
