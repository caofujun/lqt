...
<div class="easyui-layout" style="width: 100%;height: 100%;">
	...
	<table class="table_cx" cellpadding="0" cellspacing="0">
		<tbody>
			<tr>
				<td class="t_title">上报开始时间：</td>
				<td>
					<input type="text" id="startDate${id}" name="startDate" value="${startDate}" style="width:120px"  class="Wdate text" onclick="WdatePicker()"  />
				</td>
			</tr>
			<tr>
				<td class="t_title">上报结束时间：</td>
				<td>
					<input type="text" id="endDate${id}" name="endDate" value="${endDate}" style="width:120px" class="Wdate text" onclick="WdatePicker()" />
				</td>
			</tr>
		</tbody>
	</table>
