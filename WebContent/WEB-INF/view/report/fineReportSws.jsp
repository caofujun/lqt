...
<body>
	...
	<div data-options="iframe:true,region:'center'" style="border-width: 0px;">
			 <div id="patient_frame_tabs" data-options="fit:true,plain:true">		  
		       <nis:auth menuNo="D080801">
			       <div title="手卫生用品监测统计"  data-options="href:'${webroot}/report/f_view/fineReportSwsFrame.shtml?reportFile=nis7/SWSYPTJ&__bypagesize__=false&id=sws1'">	           
			       </div>
		       </nis:auth>
		    </div>            
	 </div>
