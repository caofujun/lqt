...
<body class="easyui-layout">
	...
	<div data-options="region:'west',border:false,title:'查询条件'" style="width:240px;">
		<div id="mainTB">
			<form id="suspectForm"> 
			<table class="table_cx mb60" cellpadding="0" cellspacing="0">
				<tbody>
					<tr>
			...
			<div class="m_search_last">					
				<div class="btn_r">					
					<div class="n_btn_grey">
						<a href="javascript:;" onclick="excludeCheckedRow(-1);"><span><i class="icon iconfont">&#xe669;</i>批量移除</span></a>
					</div>	
				</div>		
			</div>
		</div>
	...
	<script type="text/javascript">
		...
		function crbbk(pname,zyid,mzid){
			...
			Comm.dialogGlobal({
		    	url:"${webroot}/cdc/f_view/toChooseCard.shtml?zyid="+zyid+"&mzid="+mzid+"&isShowCards=hide&ownership=${param.ownership}",
