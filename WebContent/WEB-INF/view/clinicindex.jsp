...
<title>医院感染实时监控平台</title>
<jsp:include page="/WEB-INF/view/core/res.jsp"></jsp:include>
</head>
<body>
<div class="pwd_wrap">
  <jsp:include page="/WEB-INF/view/core/clinicheader.jsp">
  	<jsp:param name="type" value="login"/>
  </jsp:include>
  <div class="pwd_main padd_0 login_bg">
  <div class="login_banner w960 center">
    <div class="login_box">
		<div class="hd">欢迎登录</div>
		<div class="field username-field">
			<label for="TPL_username_1" class="iconfont"></label>
			<input type="text" class="login-text J_UserName" id="username" name="username" value="" maxlength="32" tabindex="1" placeholder="帐号/手机号/邮箱">
			<span class="nickx" href="javascript:void(0)" style="display: block;" onclick="$('#username').val('')"></span>				
		</div>
		<div class="field pwd-field">
			<label class="iconfont"></label>
			<input type="password" class="login-text" id="password" name="password" value="" maxlength="1000" tabindex="2" placeholder="请输入登录密码">
		</div>
