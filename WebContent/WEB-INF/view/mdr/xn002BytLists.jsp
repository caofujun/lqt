...
<div class="easyui-layout" style="width:100%;height:100%;" data-options="fit:true">
	<div id="patient_frame_tabs" class="easyui-tabs" data-options="fit:true,plain:true" style="border-width: 0px;">
	       <div title="标准病原体字典"  style="overflow:hidden"  data-options="href:'${webroot}/xn002Byt/f_view/index.shtml'"></div>
		   <div title="抗菌药物字典"  style="overflow:hidden"  data-options="href:'${webroot}/antibiosisDrug/f_view/index.shtml'"></div>
	 </div>
</div>
