...
<%-- 			<tr>
			...
			<tr>
				<td class="t_title"><span class="red">*</span>重点菌名称：</td>
				<td><input type="text" id="code" name="dictName"
					value="<c:out value="${sysDict.dictName}" />" class="easyui-validatebox text"
					required="true"></td>
				<td class="t_title"><span class="red">*</span>重点菌编码：</td>
				<td><input type="text" id="id_dictCode" name="dictCode" 
			...
			<tr>
				...
				<td colspan="3"><textarea name="remark"
						style="width: 95%; height: 60px; resize: none;" class="easyui-validatebox"><c:out value="${sysDict.remark}" /></textarea>
				</td>
			</tr>
		</tbody>
	</table>
		...
		function() {
			window.setTimeout(function() {
				...
				$('#code').live('blur',function() {
					...
					$("#id_dictCode").val($(this).pinyinFirstLower().toUpperCase());
				});
				Csm.select.load({
					id : 'parentCode',
