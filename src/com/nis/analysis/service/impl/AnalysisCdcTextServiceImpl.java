...
@Component
public class AnalysisCdcTextServiceImpl implements AnalysisCdcTextService {
	private static final Logger c = Logger.getLogger(AnalysisCdcTextServiceImpl.class);
				...
				while (true) {
					...
					while (arg27.hasNext()) {
						...
						if ("3".equals(result.getElementType()) && !"1".equals(result.getBhElement())
								&& !keyMap.containsKey(result.getElementid())) {
