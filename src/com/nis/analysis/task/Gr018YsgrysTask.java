...
@Component
public class Gr018YsgrysTask implements NisTaskService {
	private static final Logger logger = Logger.getLogger(Gr018YsgrysTask.class);
	...
	public void execute(Result<?> result) {
		...
		try {
			...
			sysJudgeLog.setJudgeCode(ae.il.getCode());
